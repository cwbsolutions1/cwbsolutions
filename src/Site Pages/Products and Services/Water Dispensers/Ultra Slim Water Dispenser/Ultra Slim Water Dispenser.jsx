...
import './Ultra Slim Water Dispenser.css'
import image from './What-are-High-Resolution-Images.png'
import coinWaterDispenser from './coin-operated-water-dispenser.png'

const UltraSlimWaterDispenser = () =>{
    return(
        <div className='ultra-slim-water-dispenser'>
            <h1>Ultra Slim Water Dispenser</h1>
                    ...
                    <div className='common-buy-now-right-block'>
                        <h6>Ultra Slim Water Dispenser</h6>
                        <p>This faceplate unit is perfect to fit custom make box designs for customers whom require slim fit solutions for areas with space restrictions. Perfect solution for public showers, swimming pools etc. 
                        </p>
...
export default UltraSlimWaterDispenser;